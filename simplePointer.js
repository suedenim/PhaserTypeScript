...
var simplePointer = (function () {
    ...
    simplePointer.prototype.preload = function () {
        var loader = this.game.load.image("jet", "Images/jet.png");
    };
    simplePointer.prototype.create = function () {
        ...
        //this.jetSprite.pivot = new Phaser.Point(this.jetSprite.width / 2, this.jetSprite.height / 2);
    };
...
window.onload = function () {
    var game = new simplePointer();
};
//# sourceMappingURL=simplePointer.js.map