...
var SimpleCursorKeys = (function () {
    function SimpleCursorKeys() {
    ...
    SimpleCursorKeys.prototype.preload = function () {
        var loader = this.game.load.image("jet", "Images/jet.png");
    };
    SimpleCursorKeys.prototype.create = function () {
    ...
    SimpleCursorKeys.prototype.update = function () {
        // Update input state
    ...
    return SimpleCursorKeys;
})();
window.onload = function () {
    var game = new SimpleCursorKeys();
};
//# sourceMappingURL=simpleCursorKeys.js.map