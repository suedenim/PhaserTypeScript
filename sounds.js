...
var SoundControls = (function () {
    ...
    SoundControls.prototype.preload = function () {
        this.game.load.audio("GameMusic", ["song.mp3"]);
        this.game.load.image("button", "button.png", false);
    };
    SoundControls.prototype.render = function () {
        this.game.debug.soundInfo(this.sound, 100, 100);
    };
    SoundControls.prototype.create = function () {
        var _this = this;
...
var SimpleSound = (function () {
    ...
    SimpleSound.prototype.preload = function () {
        this.game.load.audio("GameMusic", ["song.mp3", "song.ogg"]);
    };
    SimpleSound.prototype.create = function () {
        this.sound = this.game.add.audio('GameMusic');
        this.sound.play();
    };
    return SimpleSound;
